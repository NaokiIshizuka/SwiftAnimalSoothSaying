...
class RegisterViewController: UIViewController {
    ...
    let characterAnimal = ["長距離ランナーのチーター", "社交的なたぬき", "落ち着きのない猿", "フットワークの軽いコアラ", "面倒見のいい黒ひょう", "愛情あふれる虎", "全力疾走するチーター", "磨き上げられたたぬき", "大きな志をもった猿", "母性豊かなコアラ", "正直なこじか", "人気者のゾウ", "根が明るいの狼", "協調性のないひつじ", "どっしりした猿", "コアラの中のコアラ", "強い意志をもったこじか", "デリケートなゾウ", "放浪の狼", "もの静かなひつじ", "落ち着きのあるペガサス", "強靭な翼をもつペガサス", "無邪気なひつじ", "クリエイティブな狼", "穏やかな狼", "ねばり強いひつじ", "波乱に満ちたペガサス", "優雅なペガサス", "チャレンジ精神旺盛なひつじ", "順応性のある狼", "リーダーとなるゾウ", "しっかり者のこじか", "活動的なコアラ", "気分屋の猿", "頼られるとうれしいひつじ", "好感のもたれる狼", "まっしぐらに突き進むゾウ", "華やかなこじか", "夢とロマンのコアラ", "尽くす猿", "大器晩成のたぬき", "足腰の弱いチーター", "動きまわる虎", "情熱的な黒ひょう", "サービス精神旺盛なコアラ", "守りの猿", "人間味あふれるたぬき", "品格のあるチーター", "ゆったりとした悠然の虎", "落ち込みの激しい黒ひょう", "我が道をいくライオン", "統率力のあるライオン", "表情豊かな黒ひょう", "楽天的な虎", "パワフルな虎", "気どらない黒ひょう", "感情的なライオン", "傷つきやすいライオン", "束縛をきらう黒ひょう", "慈悲深い虎"]
